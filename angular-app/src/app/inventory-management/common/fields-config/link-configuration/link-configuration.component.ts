...
import { LinkOutputConfigurationPage } from 'src/app/inventory-management/models/fields/link-output/link-output-configuration-page';
...
export class LinkConfigurationComponent implements OnInit {
  pageObject: LinkOutputConfigurationPage = new LinkOutputConfigurationPage();
  ...
  constructor(
    ...
    private linkConfigurationEdition: LinkConfigurationEditionService,
  ...
  createField(value: any) {
    ...
    this.pageObject.fieldConfiguration.displayName = value.displayNameInput;
    this.pageObject.fieldConfiguration.url = value.linkInput;
    let result = this.linkConfigurationEdition.validForm(
    ...
    if (result === false) {
      ...
      this.fieldConfigurationSharingService.updateConfiguration({
        ...
        fieldCategory: FieldType.link_output,
      });
  ...
  updateField(value: any) {
    ...
    this.pageObject.fieldUpdated.displayName = value.displayNameInput;
    this.pageObject.fieldUpdated.url = value.linkInput;
    let result = this.linkConfigurationEdition.validForm(
