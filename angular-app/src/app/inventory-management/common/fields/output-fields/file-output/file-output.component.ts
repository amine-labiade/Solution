...
import { FileOutputConfigurationPage } from 'src/app/inventory-management/models/fields/file-output/file-output-configuration-page';
...
export class FileOutputComponent implements OnInit {
  ...
  pageObject :  FieldConfiguration = {configuration : null, fieldCategory : FieldType.file_output}
  ngOnInit(): void {
