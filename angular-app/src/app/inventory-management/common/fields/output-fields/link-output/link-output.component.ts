...
@Component({
  selector: 'app-link-output',
  templateUrl: './link-output.component.html',
  styleUrls: ['./link-output.component.css'],
})
export class LinkOutputComponent implements OnInit {
  ...
  pageObject :  FieldConfiguration = {configuration : null, fieldCategory : FieldType.link_output}
  ngOnInit(): void {
